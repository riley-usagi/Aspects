@MainActor public struct AspectCurrentContext: AspectContext {
  
  @usableFromInline internal let _store: StoreContext
  ...
  @inlinable
  @_disfavoredOverload
  @discardableResult public func refresh<Node: AsyncAspect>(_ aspect: Node) async -> Node.Produced {
  ...
  @inlinable @_disfavoredOverload public func reset<Node: Aspect>(_ aspect: Node) {
    _store.reset(aspect)
  }
  
  @inlinable public func reset<Node: Resettable>(_ aspect: Node) {
    _store.reset(aspect)
  }
}
